...
class Game{
    constructor({ player, table, dealerPoints, playerPoints, hitButton, standButton, messageBox}){
    ...
    endTheGame(){
        ...
        if(this.playerPoints < 21 && this.player.points == this.dealer.points){
...
const player = new Player('Lu');
//utworzenie nowej gry z propertami
const game = new Game({
